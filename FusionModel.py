...
class FusionModel(nn.Module):
    ...
    def forward(self, atom_list, bond_list, atom_degree_list, bond_degree_list, atom_mask, x, edge_index, edge_weight, batch):

        _, _, fingerprint_feature = self.fingerprint_model(atom_list, bond_list, atom_degree_list, bond_degree_list, atom_mask)
